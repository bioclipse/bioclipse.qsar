...
public class QsarPackageImpl extends EPackageImpl implements QsarPackage {
	 ...
	 * @generated
	 */
    public EAttribute getDescriptorresultType_ErrorString() {
    ...
    public EAttribute getDescriptorresultType_Structureid() {
		return (EAttribute)descriptorresultTypeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getMetadataType_ResponseLabel() {
	 ...
	 * @generated
	 */
	public EAttribute getMetadataType_ResponsePlacement() {
    ...
    public void createPackageContents() {
		...
		createEAttribute(descriptorresultTypeEClass, DESCRIPTORRESULT_TYPE__ERROR_STRING);
		...
		createEAttribute(metadataTypeEClass, METADATA_TYPE__RESPONSE_LABEL);
		createEAttribute(metadataTypeEClass, METADATA_TYPE__RESPONSE_PLACEMENT);
    ...
    public void initializePackageContents() {
		...
		initEAttribute(getDescriptorresultType_ErrorString(), theXMLTypePackage.getString(), "errorString", null, 0, 1, DescriptorresultType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetadataType_ResponseLabel(), theXMLTypePackage.getString(), "responseLabel", "", 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMetadataType_ResponsePlacement(), theXMLTypePackage.getString(), "responsePlacement", "first", 0, 1, MetadataType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getResourceType_ContainsErrors(), theXMLTypePackage.getBoolean(), "containsErrors", null, 0, 1, ResourceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getDescriptorresultType_ErrorString(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "errorString"
		...
		addAnnotation
		  (getMetadataType_ResponsePlacement(), 
		   source, 
		   new String[] {
			 "kind", "attribute",
			 "name", "responsePlacement"
		   });		
		addAnnotation
		  (getMetadataType_URL(), 
		   source, 
