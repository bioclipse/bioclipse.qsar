...
/**
 * This is the item provider adapter for a {@link net.bioclipse.qsar.ResourceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_checksum_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_checksum_feature", "_UI_ResourceType_type"),
				 QsarPackage.Literals.RESOURCE_TYPE__CHECKSUM,
				 true,
				 false,
				 false,
    ...
    protected void addExcludedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_excluded_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_excluded_feature", "_UI_ResourceType_type"),
				 QsarPackage.Literals.RESOURCE_TYPE__EXCLUDED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 QsarPackage.Literals.RESOURCE_TYPE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addNo2dPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_no2d_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_no2d_feature", "_UI_ResourceType_type"),
    ...
    protected void addNo3dPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceType_no3d_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceType_no3d_feature", "_UI_ResourceType_type"),
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(QsarPackage.Literals.RESOURCE_TYPE__STRUCTURE);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(QsarPackage.Literals.RESOURCE_TYPE__STRUCTURE,
				 QsarFactory.eINSTANCE.createStructureType()));
	}
